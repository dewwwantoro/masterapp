...
$string .="\n\n    // datatables
    function json() {
        ...
        \$this->datatables->add_column('action', anchor(site_url('".$c_url."/read/\$1'),'<i class=\"fa fa-binoculars\"></i>').\" \".anchor(site_url('".$c_url."/update/\$1'),'<i class=\"fa fa-edit\"></i>').\"  \".anchor(site_url('".$c_url."/delete/\$1'),'<i class=\"fa fa-trash\"></i>','onclick=\"javasciprt: return confirm(\\'Are You Sure ?\\')\"'), '$pk');
