...
$string .= "\n\n    public function index()
    {
        ...
        \$this->template->load('layout','$c_url/$v_list',\$data);
    }";
...
$string .="\n\n    public function index()
    {
        \$this->cekAkses();
            \$this->template->load('layout','$c_url/$v_list');
    } 
...
$string .= "\n\t    );
            ...
            \$this->template->load('layout','$c_url/$v_read',\$data);
        } else {
...
$string .= "\n\t);
        ...
        \$this->template->load('layout','$c_url/$v_form',\$data);
    }
